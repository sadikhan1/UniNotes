      ...
      <div className="flex gap-6 items-start">
        ...
        <aside className="hidden lg:block w-56 shrink-0">
          <div className="bg-white border border-gray-200 rounded-lg p-4 sticky top-4">
            <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Yaşar Üniversitesi Bölümleri</h2>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="lg:hidden mb-4 -mx-1">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 px-1">Bölümler</p>
