...
export const tr = {
  ...
  // Authentication
  platformSubtitle: 'Yaşar Üniversitesi Öğrenci Platformu',
  ...
  departmentRequired: 'Bölüm gerekli',
  ...
  publicNotesTab: 'Herkese Açık Notlar',
  savedNotesTab: 'Kaydedilen Notlar',
  userNotFound: 'Kullanıcı bulunamadı.',
  noSavedNotes: 'Henüz kaydedilen not yok.',
